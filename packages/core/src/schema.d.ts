...
export interface components {
  ...
  schemas: {
        ...
        | {
            ...
            object: {
              ...
              cancellation_events: {
                ...
                custom_reason_text: null | string;
                /**
                 * @description The entity that initiated the cancellation.
                 * @enum {string}
                 */
                initiated_by: "client" | "user";
                /** @enum {string} */
                object: "cancellation_event";
                /**
                 * Format: datetime
                 ...
                 * @enum {string}
                 */
                source: "api" | "client_ui" | "dashboard";
              }[];
              /**
               * Client
              ...
              service: {
                ...
                slot_rules: {
                  ...
                  recurrence_rule: {
                     ...
                     * @example 2024-01-02
                     */
                    until?: null | Record<string, never>;
                  };
    ...
    Block: {
       ...
       * @enum {string}
       */
      attachment_type: "location" | "provider" | "service_provider" | "service";
    ...
    Role: {
       ...
       * @enum {string}
       */
      type: "admin" | "custom" | "developer" | "staff" | "superuser";
    };
    /**
     * RolesResponse
